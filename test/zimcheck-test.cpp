...
TEST(zimcheck, internal_url_check_poorzimfile)
{
    const std::string expected_stdout(
      ...
      "[ERROR] Internal URL: anchor_target.html#missing has a broken anchor. Article: broken_anchor_cross_page.html" "\n"
      "[ERROR] Internal URL: #missing has a broken anchor. Article: broken_anchor_same_page.html" "\n"
...
TEST(zimcheck, json_poorzimfile)
{
    ...
    ASSERT_EQ(
      ...
      "      \"check\" : \"url_internal\","                                 "\n"
      "      \"level\" : \"ERROR\","                                        "\n"
      "      \"message\" : \"anchor_target.html#missing has a broken anchor. Article: broken_anchor_cross_page.html\"," "\n"
      "      \"link\" : \"anchor_target.html#missing\","                    "\n"
      "      \"path\" : \"broken_anchor_cross_page.html\""                  "\n"
      "    },"                                                              "\n"
      "    {"                                                               "\n"
      "      \"check\" : \"url_internal\","                                 "\n"
      "      \"level\" : \"ERROR\","                                        "\n"
      "      \"message\" : \"#missing has a broken anchor. Article: broken_anchor_same_page.html\"," "\n"
      "      \"link\" : \"#missing\","                                      "\n"
      "      \"path\" : \"broken_anchor_same_page.html\""                   "\n"
      "    },"                                                              "\n"
      "    {"                                                               "\n"
      "      \"check\" : \"url_internal\","                                 "\n"
      "      \"level\" : \"ERROR\","                                        "\n"
